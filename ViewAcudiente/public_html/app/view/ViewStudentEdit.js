Ext.define('schoolBus.view.ViewStudentEdit', {
    extend: 'Ext.Panel',
    alias: 'widget.viewstudentedit',
    config: {
        cls: 'background-user',
        scrollable: 'vertical',
        items: [
            ...
            },
            {
                xtype: 'container',
                cls: 'title-container',
                html: 'Actualizar Información Niño'
            },
            {
                xtype: 'panel',
                autoScroll: 'true',
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            },
                            {
                                xtype: 'button',
                                cls: 'image-location',
                                itemId: 'btnLocationEdit'
                            }
                        ]
                    },
                    {
                        xtype: 'button',
                        itemId: 'btnSaveStudentEdit',
                        cls: 'button-login',
                        text: 'Guardar'
                    }
                ]
